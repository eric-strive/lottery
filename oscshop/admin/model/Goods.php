                ...
                if (isset($data['goods_option'])) {
                    ...
                    foreach ($data['goods_option'] as $goods_option) {
                        if ($goods_option['type'] == 'select' || $goods_option['type'] == 'radio' || $goods_option['type'] == 'checkbox') {
                            ...
                            $option_id = Db::name('goods_option')->insert([
                                'goods_id' => (int)$goods_id, 'option_id' => (int)$goods_option['option_id'],
                                'required' => (int)$goods_option['required'], 'option_name' => $goods_option['name'],
        ...
        if (isset($data['goods_option'])) {
            foreach ($data['goods_option'] as $goods_option) {
                if ($goods_option['type'] == 'select' || $goods_option['type'] == 'radio'
                    ...
                    $option_id = Db::name('goods_option')->insert([
                        'goods_id' => (int)$id, 'option_id' => (int)$goods_option['option_id'],
                        'required' => (int)$goods_option['required'], 'option_name' => $goods_option['name'],
                        'type' => $goods_option['type']
                    ], false, true);
