var time = 30000
var CarDiv = [9, 1, 10, 6, 4, 5, 3, 2, 8, 7];      //比赛结果顺序
var t;
for (var i = 0; i < CarDiv.length; i++) {
    var rand = parseInt(Math.random() * CarDiv.length);
    t = CarDiv[rand];
    CarDiv[rand] = CarDiv[i];
    CarDiv[i] = t;
}
var timer = '';
$(function () {
...
function timeTo() {
    ...
    timer = setInterval(function () {
        ...
        if (secomd > 2) {
            ...
            $(".car1").animate({left: ss * 500}, 2000);
            $(".car2").animate({left: ss2 * 500}, 2000);
            $(".car3").animate({left: ss3 * 500 - 10}, 2000);
            $(".car4").animate({left: ss4 * 500 - 20}, 2000);
            $(".car5").animate({left: ss5 * 500 - 30}, 2000);
            $(".car6").animate({left: ss6 * 500 - 40}, 2000);
            $(".car7").animate({left: ss7 * 500 - 50}, 2000);
            $(".car8").animate({left: ss8 * 500 - 60}, 2000);
            $(".car9").animate({left: ss9 * 500 - 70}, 2000);
            $(".car10").animate({left: ss10 * 500 - 80}, 2000);
            secomd--;
            for (let i = 1; i <= 10; i++) {
...
function placeAnimate1() {
    $('.place1').animate({left: '420px', top: '195px'}, 500, function () {
        placeAnimate12()
    })
}
...
function placeAnimate12() {
    $('.place2').show()
    $('.place2').animate({left: '185px', top: '150px'}, 500, function () {
        placeAnimate13()
    })
}
...
function placeAnimate13() {
    $('.place3').show()
    $('.place3').animate({left: '670px', top: '150px'}, 500)
}
