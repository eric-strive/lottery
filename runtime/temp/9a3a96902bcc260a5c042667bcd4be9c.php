<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./themes/default/member/payment/edit.html";i:1555075681;s:37:"./oscshop/admin/view/public/base.html";i:1555075680;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="row">
	<div class="col-xs-12">	
		<div class="form-horizontal">
			 ...
			 <form action="<?php echo url('Payment/edit'); ?>" method="post" class="form-horizontal">
			...
			<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?>
				<div class="form-group required">
					<label class="col-sm-2 control-label" for="input-name2"><?php echo $p['info']; ?>：</label>
					<div class="col-sm-10">
						<input id="input-name2" class="form-control" type="text" placeholder="<?php echo $p['info']; ?>" name="<?php echo $p['name']; ?>"  value="<?php echo $p['value']; ?>" />
					</div>
				</div>
			<?php endforeach; endif; else: echo "" ;endif; ?>
				<div class="form-group">
					...
					<div class="col-sm-11">
						<button type="submit" id="send"  class="btn btn-sm btn-primary">提交</button>		
					</div>
				</div>
			</form>
		</div>
