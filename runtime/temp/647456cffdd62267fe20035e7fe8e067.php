<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./themes/default/mobile/settings_backend/mobile.html";i:1555075681;s:37:"./oscshop/admin/view/public/base.html";i:1555075680;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="form-horizontal">	
			...
			<div class="col-sm-10">
				<div class="clearfix">					
						...
						<?php if(is_array($transport) || $transport instanceof \think\Collection || $transport instanceof \think\Paginator): $i = 0; $__LIST__ = $transport;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$t): $mod = ($i % 2 );++$i;?>
							<option <?php if($t['id'] == config('default_transport_id')): ?> selected="selected"<?php endif; ?> value="<?php echo $t['id']; ?>"><?php echo $t['title']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>				
						</select>		
				</div>
			</div>
			...
			<div class="col-sm-10">
				<div class="clearfix">
					<input class="col-xs-10 col-sm-10 form-control" name="cash_num" type="text" value="<?php echo \think\Config::get('cash_num'); ?>" >
				</div>
			</div>
			</div>
...
<script>
$(function(){
	Oscshop.setValue("use_captcha", '<?php echo \think\Config::get('use_captcha'); ?>');		

});	
$('#send').click(function(){
	$.post(
		"<?php echo url('admin/Settings/save'); ?>",
