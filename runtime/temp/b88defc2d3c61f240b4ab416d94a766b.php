<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./themes/default/mobile/reply_backend/text.html";i:1555075681;s:37:"./oscshop/admin/view/public/base.html";i:1555075680;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<div class="page-header">
	<a href="<?php echo url('ReplyBackend/text_add'); ?>" class="btn btn-primary">新增</a>
</div>	
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
						...
						<tr>
							...
							<td>
								<?php switch($data['status']): case "1": ?>是<?php break; case "0": ?>否<?php break; endswitch; ?>
							</td>
							<td>
								<a  class="btn btn-xs btn-info" href='<?php echo url("ReplyBackend/text_edit",array("id"=>$data["tr_id"])); ?>'>
									<i class="fa fa-edit bigger-120"></i>
								</a> 
								<a class="delete btn btn-xs btn-danger" href='<?php echo url("ReplyBackend/text_del",array("id"=>$data["rid"])); ?>' >
						...
						<tr>
							<td colspan="20" class="page">总计 <?php echo ($list->total() ?: "0"); ?> </td>
						</tr>
				</tbody>
