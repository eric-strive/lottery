<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./themes/default/member/menu_backend/index.html";i:1555075681;s:37:"./oscshop/admin/view/public/base.html";i:1555075680;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
...
function save(type){
		...
		if(type=='add'){
			url='<?php echo url("MenuBackend/add"); ?>';
		}else if(type=='edit'){
			url='<?php echo url("MenuBackend/edit"); ?>';
		}
...
function edit() {
	...
	var zTree = $.fn.zTree.getZTreeObj("category_tree"),
		...
		if (nodes.length == 0) {
			...
			var id=treeNode.id;
			$.post(
				'<?php echo url("MenuBackend/get_info"); ?>',
				{					
					'id':id,
