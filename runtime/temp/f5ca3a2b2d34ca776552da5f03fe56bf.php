<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./themes/default/member/payment/index.html";i:1555075681;s:37:"./oscshop/admin/view/public/base.html";i:1555075680;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<table class="table table-striped table-bordered table-hover">
				...
				<tbody>
					...
					<tr>					
						...
						<td>								
							<?php switch($data['status']): case "1": ?><a href='<?php echo url("Payment/set_status",array("code"=>$data["code"],"status"=>0)); ?>'><span class="btn btn-xs btn-success"><i class="fa fa-check bigger-120"></i></span></a><?php break; case "0": ?><a href='<?php echo url("Payment/set_status",array("code"=>$data["code"],"status"=>1)); ?>'><span class="btn btn-xs btn-danger"><i class="fa fa-remove bigger-120"></i></span></a><?php break; endswitch; ?>								
						</td>
						<td>
							<a class="btn btn-xs btn-info" href='<?php echo url("Payment/edit",array("code"=>$data["code"])); ?>' >
